"========================================List========================================"
# список - это изменяемый, итерируемый, индексируемый и упорядочунный 
# тип данных, предназначенный для хранения элементов в строгом порядке.

list1 = [10, 3.5, 'hello', [], (1,2), None, True, False]
list1[0] # 10
list1[3] # [1,2,3]
list1[3][-1] # 3
...
list3 = list(range(3,10,2)) # 3, 5, 7, 9
list3 = list(range(3,10,1)) # 3, 4, 5, 6, 7, 8, 9
...
# но только первого вхождение этого элемента, выдаст ошибку 
# ValueError, если такого нет в списке
list2 = [10, 'hello', 500, 'world', 1000, 'hello', 500]
list2.remove('hello')
print(list2) # [10, 500, 'world', 1000, 'hello', 500]

# pop - метод, который удаляет элемент из списка по индексу, если этого индекса 
# нет, выдаст indexError
list3 = [10, 20, 30, 40, 50]
list3.pop() # удаление с конца
print(list3) #[10,20,30.50]
